...
class SimConfig:
    ...
    out_dir: str = "95_threshold" #output directory for simulation states
    ...
    thresholding: bool = True #cell-level specific heteroplasmy thresholding; if True = use neutral heteroplasmy threshold gating for selection
    ...
    transfer_event_prob: float = 0 #probability of a cell's transfer event at a particualr pre-mitotic generation
